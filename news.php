...
<body>
  ...
  <script>
    ...
    ?>
        ...
        newsTextElement.style.height = "260px";
        ...
        if (newsTextElement.scrollHeight > newsTextElement.clientHeight) {
          ...
          linkReadMoreElement.addEventListener("click", toggleTextLength);
        ...
        function toggleTextLength(e) {
          //e.currentTarget is a div with the class=.see-more-wrapper
          // console.log("click was on the element ", e.currentTarget);
          //previousSibling of the div.see-more-wrapper is p-element with class .item-text
          //It is an element whos height we need to control - show or hide:
          let textElement = e.currentTarget.previousSibling;
          // console.log("the textElement is = ", textElement);
          if (textElement.style.height == "260px") {
            // console.log("The height of the element is ", textElement.style.height);
            //change the button name from Näytä lisää to Sulje:
            e.currentTarget.firstChild.innerHTML = "Sulje";
            //delete the height of the p-element from 260px to auto:
            textElement.style.height = "auto";
            //change the arrow's direction from down to up:
            e.currentTarget.lastChild.classList.remove("uis-angle-down");
            e.currentTarget.lastChild.classList.add("uis-angle-up");
          } else {
            // console.log("The height of the element is ", textElement.style.height);
            //change the button name from Sulje to Näytä lisää:
            e.currentTarget.firstChild.innerHTML = "Näytä lisää";
            //return the height of the p-element from auto to 260px:
            textElement.style.height = "260px";
            //return the arrow's direction from up to down:
            e.currentTarget.lastChild.classList.remove("uis-angle-up");
            e.currentTarget.lastChild.classList.add("uis-angle-down");
          }
        }
